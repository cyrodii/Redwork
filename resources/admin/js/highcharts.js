...
$(function(e){
  'use strict';
		...
		Highcharts.chart('hightchart1', {
			...
			xAxis: {
				gridLineColor: ' rgb(119, 119, 119,0.2)',
				allowDecimals: false,
				labels: {
					style: {
						color: '#8c8c8c',
  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#204cd9', '#9842e5', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572' ,'#24CBE5', '#204cd9', '#9842e5' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#9842e5' , '#204cd9', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#204cd9', '#9842e5', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
