    ...
    $.fn.richText = function( options ) {
        ...
        $editor.find(".richText-help").on("click", function() {
            ...
            if($editor) {
                ...
                var $inner = $('<div />', {style: 'position:relative;margin:60px auto;padding:20px;background-color:#313030;width:70%;font-family:Calibri,Verdana,Helvetica,sans-serif;font-size:small;'});
